...
const userUrl = 'https://api.github.com/users/victormonteiro2';
const repos_url = 'https://api.github.com/users/victormonteiro2/repos';
const starred_url = 'https://api.github.com/users/victormonteiro2/starred';
...
const renderReposByList = (repos, element) => {
  ...
  for (i = 0; i < repos.length; i++) {
    element.innerHTML += `
    <ul>
      <li><a href="https://github.com/victormonteiro2/${repos[i]['name']}">${repos[i]['name']}</a></li> 
    </ul>
    `;
  }
};
